...
const harry = {
  tom: "fish",
  jarry: 1,
  collection: ["Joker", "Skull", "Queen", "Fox"],
  jack: {
    frost: console.log("Tom like fish"),
    kiryu: console.log("Jarry like cheese")
  }
}

// Access a value in the "collection" property

const showCollection = harry.collection[2];
