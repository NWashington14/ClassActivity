...
let favoriteThing = "Games";
console.log(favoriteThing);
// You heard a new song that became your favorite.
// Reassign the variable "favoriteSong"
favoriteSong = "Chamber of reflection";
...
console.log("Hi my name is " + name + ", and my favorite song is " + favoriteSong + ".");
